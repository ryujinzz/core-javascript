...
// 클로저 (closure) 란? (폐쇄) 가바지 컬렉터로부터 보호한다.
...
// const value1 = first()();
//함수를 여러번 실행하는걸 커링 펑션을 한다.
//currying function

const value2 = first; //first가 밸류를 참조하므로 외부함수가 종료돼도 이너함수때문에 스택에도 계속 남아있다. 서로가 서로의 구명튜브의 체인과 같은 연결을 하고 있음
value2();
